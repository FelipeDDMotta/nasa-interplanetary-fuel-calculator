defmodule FuelCalculatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FuelCalculatorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FuelCalculatorWeb.Gettext, "errors", msg, opts)
    end
  end
